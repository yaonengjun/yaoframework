...
<body style="margin: 25px;">
	...
	<% int i = 1; %>
	<ec:table  items="pres" action="./test1.jsp" imagePath="./images/*.gif"  title="Presidents" width="60%" rowsDisplayed="5" >
		<ec:row >
			<ec:column property="name"> <ec:column property="name"  /><image src="./images/picture.png" /> </ec:column>
